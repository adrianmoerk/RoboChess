        ...
        #aliases for the gripper variable names
          ...
          def rq_print_gripper_fault_code(gripper_socket=\"1\"):
                ...
                if(is_FLT_no_fault(gFLT)):
                        ...
                        textmsg(\"Gripper Fault : \", \"Priority Fault: Action delayed, initialization must be complete
        d prior to action (0x05)\")                                                                                          elif (is_FLT_not_activated(gFLT)):
                        textmsg(\"Gripper Fault : \", \"Priority Fault: The activation must be set prior to action (0x0
        7)\")                                                                                                                elif (is_FLT_autorelease_in_progress(gFLT)):
